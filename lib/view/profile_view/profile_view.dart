...
import 'package:social_media/view/profile_view/setting_view/setting_view.dart';
import 'package:social_media/view/profile_view/widget/container_view_card.dart';
import 'package:social_media/view_model/controller/profile_controller/profile_controller.dart';
...
class _ProfileViewState extends State<ProfileView> {
  ...
  void initState() {
    ...
    profileController.fetchFollowings();
  }
                      ...
                      children: [
                        ...
                        RichText(
                          text: TextSpan(
                            children: [
                              TextSpan(
                                text: profileController.followerData.value.data?.isEmpty ?? true
                                    ? "0 "  // If the data is empty or null, show "0"
                                    : "${profileController.followerData.value.data!.length} ",
                                style: TextStyle(
                                  color: Colors.black,
                                  fontSize: 14,
                                  fontWeight: FontWeight.w500,
                        ...
                        RichText(
                          text: TextSpan(
                            children: [
                              TextSpan(
                                text:
                                    "${profileController.followingData.value.data!.length} ",
                                style: TextStyle(
                                  color: Colors.black,
                                  fontSize: 14,
                                  fontWeight: FontWeight.w500,
